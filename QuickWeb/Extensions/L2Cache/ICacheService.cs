...
* 类 名 称：ICacheService
* 创 建 者：Qing
* 创建时间：2019/04/10 11:05:02
* CLR 版本：4.0.30319.42000
* 保存的文件名：ICacheService
* 文件版本：V1.0.0.0
*
* 功能描述：N/A 
*
...
namespace QuickWeb.Extensions.L2Cache
{
    ...
    public interface ICacheService
    {
        ...
        /// <param name="expiresAbsolute">绝对过期时长</param>
        /// <returns></returns>
        Task<bool> AddAsync(string key, object value, TimeSpan expiresSliding, TimeSpan expiresAbsolute);
        ...
        /// <param name="expiresAbsolute">绝对过期时长</param>
        /// <returns></returns>
        Task<bool> ReplaceAsync(string key, object value, TimeSpan expiresSliding, TimeSpan expiresAbsolute);
